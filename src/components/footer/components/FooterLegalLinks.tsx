export default function FooterLegalLinks() {
  return (
    <div className='flex flex-col gap-[72px] smd:mb-[72px] smd:flex-row smd:gap-0 md:mb-0'>
      <ul
        className='flex flex-col items-center gap-3 text-[18px] leading-6 smd:w-[60%] smd:flex-row
      ...
      <div
        className='text-brown-light flex flex-col items-center gap-3 text-[18px] leading-6
          smd:w-[40%] smd:flex-row smd:items-start smd:text-xs lg:w-1/2 lg:gap-8'>
